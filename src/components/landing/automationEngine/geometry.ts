...
/** Station (node) centre y, and the belt the task cards travel along. */
...
/** Task cards travel from ENTRY_X to EXIT_X along the belt, in one of two lanes (±1). */
export const ENTRY_X = 22;
export const EXIT_X = 360;
export const LANE_DY = 9;
